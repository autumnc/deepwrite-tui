...
// MoveToFirstRow and MoveToLastRow are now publicly re-exported below.
#[cfg(feature = "system-editor")]
...
pub use self::motion::{
    ...
    MovePageUp, MoveToEndOfLine, MoveToFirst, MoveToFirstRow, MoveToLastRow, MoveToMatchinBracket,
